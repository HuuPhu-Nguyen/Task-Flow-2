...
- Graceful coordinator shutdown closes intake before cancelling consumers and
  ...
  stopped. Full broker-process restart recovery remains outside this completed
