...
The object-store port and adapter metadata boundary have partial evidence, but
the invariant remains unproved until corrupt bytes are rejected before
processor invocation. See [E-I9](#e-i9).
...
| <a id="e-i9"></a> I9 | Partial; portable input references now cross real separate object-store clients without shared paths, while exact downloaded-byte verification remains open | [`ObjectStoreContractTest#putStreamsContentAndRoundTripsRequiredMetadata`](../taskflow-objectstore-minio/src/test/java/objectstore/minio/ObjectStoreContractTest.java); [`MinioObjectStoreContractTest#missingRequiredDigestMetadataIsClassified`](../taskflow-objectstore-minio/src/test/java/objectstore/minio/MinioObjectStoreContractTest.java); [`MinioObjectStoreContractTest#containerRestartPreservesStreamedObjectMetadataAndDeletion`](../taskflow-objectstore-minio/src/test/java/objectstore/minio/MinioObjectStoreContractTest.java); [`MinioObjectStoreContractTest#separateConversionParticipantsExchangeInputOnlyByPortableObjectKey`](../taskflow-objectstore-minio/src/test/java/objectstore/minio/MinioObjectStoreContractTest.java); [`MessageValidatorTest#inlineFileLimitRejectsExactBoundaryInSubmitAndAssignment`](../taskflow-spi/src/test/java/protocol/MessageValidatorTest.java); [`ObjectStoreArchitectureTest#frameworkPortAndCoordinatorStateRemainIndependentFromMinioSdk`](../taskflow-spi/src/test/java/objectstore/ObjectStoreArchitectureTest.java) | `ObjectStoreIntegrityContractTest#corruptPayloadIsRejectedBeforeProcessorInvocation` (TF-0504) | Verify exact streamed length/SHA-256 before processor invocation or authoritative output acceptance. Portable metadata, upper bounds, and a successful cross-client round trip do not prove corrupt-byte rejection. |
