...
- On current startup recovery, resumable running jobs are rebuilt from durable
  snapshots, including status, retry count, assignment generation/UUID,
  ...
  known generation; non-resumable running jobs become failed.
