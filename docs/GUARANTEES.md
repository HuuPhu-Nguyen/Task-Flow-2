...
Recovered accepted work is retained rather than evicted.
...
and [`docs/reports/admission-overload.md`](reports/admission-overload.md).

Automated evidence: [E-I7 — `AdmissionOverloadExperiment#coordinatorHeapPlateausAtConfiguredBounds`](#e-i7).
