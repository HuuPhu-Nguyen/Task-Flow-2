...
| <a id="e-i7"></a> I7 | Partial; scheduler workload indexes are bounded by accepted active work and non-due ticks are constant-work | [`SchedulerMailboxTest#createsBoundedMailboxFromSchedulerConfig`](../taskflow-core/src/test/java/server/scheduler/SchedulerMailboxTest.java); [`SchedulerMailboxTest#repeatedBrokerOverflowRequeuesDeliveriesWithoutReplacingAcceptedWork`](../taskflow-core/src/test/java/server/scheduler/SchedulerMailboxTest.java); [`SchedulerWorkloadIndexTest#profileOneTickWithOneHundredThousandNonDueAssignmentsUsesOnlyDeadlineHeads`](../taskflow-core/src/test/java/server/scheduler/SchedulerWorkloadIndexTest.java); [`SchedulerWorkloadIndexTest#repeatedDispatchClosureKeepsDeadlineIndexAtTwoEntriesPerLiveAssignment`](../taskflow-core/src/test/java/server/scheduler/SchedulerWorkloadIndexTest.java); [`PeerExecutionEngineTest#cacheBoundsAndCapacityEvictionPermitReexecution`](../taskflow-core/src/test/java/peer/engine/PeerExecutionEngineTest.java); [`PeerExecutionEngineTest#ttlEvictionPermitsReexecutionAndExposesMetric`](../taskflow-core/src/test/java/peer/engine/PeerExecutionEngineTest.java) | `OverloadExperiment#coordinatorHeapPlateausAtConfiguredBounds` (TF-0402–TF-0406/TF-0709) | Add bounded stage batches, absolute active-work admission limits, outbox/result-delivery bounds, and overload heap evidence. |
