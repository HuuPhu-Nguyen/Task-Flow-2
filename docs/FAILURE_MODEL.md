...
- the MinIO/S3 streaming port, adapter contract, local Compose environment,
  ...
  implemented. Input-object retention/deletion and the broader process-kill
  matrix remain outside the current proof;
