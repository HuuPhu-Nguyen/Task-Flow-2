...
- successful-result commitment is database-conditional on the full assignment
  tuple and same-participant ABA is fenced at the store boundary, but the
  complete deterministic scheduler and RabbitMQ scenario remains TF-0106 work;
